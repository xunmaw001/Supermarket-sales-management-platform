        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '联系人姓名' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.lianxirenName" placeholder="联系人姓名" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           v-if="isAuth('gongyingshang','导入导出')"
                           icon="el-icon-download"
                           href="http://localhost:8080/chaoshishouhuoguanlipingtai/upload/gongyingshangMuBan.xls"
                        >批量导入供应商信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('gongyingshang','导入导出')"
                                ...
                                :action="getActionUrl"
                                :on-success="gongyingshangUploadSuccess"
                                :on-error="gongyingshangUploadError"
                                :show-file-list = false>
                            <el-button
                                    v-if="isAuth('gongyingshang','导入导出')"
                                    type="success"
                                    icon="el-icon-upload2"
                            >批量导入供应商信息数据</el-button>
                        </el-upload>
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('gongyingshang','导入导出')" style="display: inline-block" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "gongyingshang.xls">
                            <!-- 导出excel -->
                            <el-button
                                    type="success"
                                    icon="el-icon-download"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="gongyingshangUuidNumber"
                                   header-align="center"
                                   label="供应商唯一编号">
                        <template slot-scope="scope">
                            {{scope.row.gongyingshangUuidNumber}}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   ...
                                   label="联系人手机号">
                        <template slot-scope="scope">
                            {{scope.row.lianxirenPhone}}
                        </template>
                    </el-table-column>

                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="lianxirenAddress"
                                   header-align="center"
                                   label="地址">
                        <template slot-scope="scope">
                            {{scope.row.lianxirenAddress}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('gongyingshang','查看')" type="success" icon="el-icon-tickets" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
                            <el-button v-if="isAuth('gongyingshang','修改')" type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
                            <el-button v-if="isAuth('gongyingshang','删除')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                id : null,
                gongyingshangUuidNumber : null,
                gongyingshangName : null,
                lianxirenName : null,
                lianxirenPhone : null,
                lianxirenAddress : null,
                gongyingshangTypes : null,
                gongyingshangXinyongdengjiTypes : null,
                gongyingshangContent : null,
                createTime : null,
            },
            dataList: [],
            pageIndex: 1,
            ...
            json_fields: {
                //级联表字段
                //本表字段
                     '供应商唯一编号': "gongyingshangUuidNumber",
                     '供应商名称': "gongyingshangName",
                     '联系人姓名': "lianxirenName",
                     '联系人手机号': "lianxirenPhone",
                     '地址': "lianxirenAddress",
                     '供应商类型': "gongyingshangValue",
                     '信用等级': "gongyingshangXinyongdengjiValue",
            },
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'gongyingshang',//当前表表名,
                        sumColum : 'gongyingshang_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'gongyingshang_name',//分组字符串字段
                        // types : 'gongyingshang_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
            ...
            getDataList() {
                ...
                if (this.searchForm.lianxirenName!= '' && this.searchForm.lianxirenName!= undefined) {
                    params['lianxirenName'] = '%' + this.searchForm.lianxirenName + '%'
                }
                ...
                params['gongyingshangDelete'] = 1// 逻辑删除字段 1 未删除 2 删除
            ...
            // 导入功能上传文件成功后调用导入方法
            gongyingshangUploadSuccess(data){
                let _this = this;
                _this.$http({
                    url: "gongyingshang/batchInsert?fileName=" + data.file,
                    method: "get"
                }).then(({data}) => {
                    if(data && data.code === 0){
                        _this.$message({
