<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='huiyuan'">
                    <el-form-item class="select" v-if="type!='info'"  label="会员" prop="huiyuanId">
                        <el-select v-model="ruleForm.huiyuanId" :disabled="ro.huiyuanId" filterable placeholder="请选择会员" @change="huiyuanChange">
                            <el-option
                                    v-for="(item,index) in huiyuanOptions"
                                    v-bind:key="item.id"
                                    :label="item.huiyuanName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='huiyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="会员编号" prop="huiyuanUuidNumber">
                        <el-input v-model="huiyuanForm.huiyuanUuidNumber"
                                  placeholder="会员编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="会员编号" prop="huiyuanUuidNumber">
                            <el-input v-model="ruleForm.huiyuanUuidNumber"
                                      placeholder="会员编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='huiyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="会员姓名" prop="huiyuanName">
                        <el-input v-model="huiyuanForm.huiyuanName"
                                  placeholder="会员姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="会员姓名" prop="huiyuanName">
                            <el-input v-model="ruleForm.huiyuanName"
                                      placeholder="会员姓名" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='huiyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="会员手机号" prop="huiyuanPhone">
                        <el-input v-model="huiyuanForm.huiyuanPhone"
                                  placeholder="会员手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="会员手机号" prop="huiyuanPhone">
                            <el-input v-model="ruleForm.huiyuanPhone"
                                      placeholder="会员手机号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='huiyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="会员身份证号" prop="huiyuanIdNumber">
                        <el-input v-model="huiyuanForm.huiyuanIdNumber"
                                  placeholder="会员身份证号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="会员身份证号" prop="huiyuanIdNumber">
                            <el-input v-model="ruleForm.huiyuanIdNumber"
                                      placeholder="会员身份证号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='huiyuan' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.huiyuanPhoto" label="会员头像" prop="huiyuanPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (huiyuanForm.huiyuanPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.huiyuanPhoto" label="会员头像" prop="huiyuanPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.huiyuanPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='huiyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="性别" prop="sexValue">
                        <el-input v-model="huiyuanForm.sexValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='huiyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="会员邮箱" prop="huiyuanEmail">
                        <el-input v-model="huiyuanForm.huiyuanEmail"
                                  placeholder="会员邮箱" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="会员邮箱" prop="huiyuanEmail">
                            <el-input v-model="ruleForm.huiyuanEmail"
                                      placeholder="会员邮箱" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
...
<script>
    ...
    export default {
        ...
        created() {
         ...
         this.$http({
             url: `huiyuan/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.huiyuanOptions = data.data.list;
            }
         });
         this.$http({
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.huiyuanChange(data.data.huiyuanId)
