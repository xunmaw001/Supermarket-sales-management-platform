        ...
        <form class="app-update-pv">
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">供应商</view>
                    <picker @change="gongyingshangChange" :value="gongyingshangIndex" :range="gongyingshangOptions" range-key="gongyingshangName">
                        <view
                                ...
                                class="uni-input">{{ruleForm.gongyingshangId?ruleForm.gongyingshangName:"请选择供应商"}}</view>
                    </picker>
                </view>-->
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.shangpinName" type="text" v-model="ruleForm.shangpinName" placeholder="商品名称"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">商品编号</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                         :disabled="ro.shangpinUuidNumber" type="text" v-model="ruleForm.shangpinUuidNumber" placeholder="商品编号"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="shangpinPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                    ...
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.shangpinPhoto" :src="baseUrl+ruleForm.shangpinPhoto" mode="aspectFill">
                        </image>
                      ...
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">商品类型</view>
                    <picker @change="shangpinTypesChange" :value="shangpinTypesIndex" :range="shangpinTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                                class="uni-input">{{ruleForm.shangpinTypes?ruleForm.shangpinValue:"请选择商品类型"}}</view>
                    </picker>
                </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <input   disabled
                             :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                             :disabled="ro.shangpinKucunNumber" type="number" v-model="ruleForm.shangpinKucunNumber" placeholder="商品库存"></input>
                </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                        class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">现价/积分</view>
                    <input   disabled
                             :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                             :disabled="ro.shangpinNewMoney" type="number" v-model="ruleForm.shangpinNewMoney" placeholder="现价/积分"></input>
                </view>
            <view
                ...
                <textarea :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","height":"200rpx"}'
                          :disabled="ro.shangpinContent" v-model="ruleForm.shangpinContent" placeholder="商品介绍"/>
            </view>
    ...
    export default {
        data() {
            ...
            ruleForm: {
					gongyingshangId: '',
					shangpinName: '',
					shangpinUuidNumber: this.getUUID(),//数字
					shangpinPhoto: '',
					shangpinTypes: '',//数字
        ...
        async onLoad(options) {
            let gongyingshangParams = {
                page: 1,
                limit: 100,
            }
            let gongyingshangData = await this.$api.page(`gongyingshang`, gongyingshangParams);
            this.gongyingshangOptions = gongyingshangData.data.list;
		/*下拉框*/
			let shangpinTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'shangpin_types',
            }
			let shangpinTypes = await this.$api.page(`dictionary`, shangpinTypesParams);
			this.shangpinTypesOptions = shangpinTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`shangpin`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.shangpinId){
                this.ruleForm.shangpinId = options.shangpinId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            gongyingshangChange(e) {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.shangpinName)) {
                    this.$utils.msg(`商品名称不能为空`);
                    return
                }
				if ((!this.ruleForm.shangpinUuidNumber)) {
                    this.$utils.msg(`商品编号不能为空`);
                    return
                }
				if ((!this.ruleForm.shangpinPhoto)) {
                    this.$utils.msg(`商品照片不能为空`);
                    return
                }
				if ((!this.ruleForm.shangpinKucunNumber) && (!this.$validate.isIntNumer(this.ruleForm.shangpinKucunNumber)) && this.ruleForm.shangpinKucunNumber >0) {
                    this.$utils.msg(`商品库存不能为空，不能小于0 格式为数字`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`shangpin`, this.ruleForm);
                } else {
                    await this.$api.save(`shangpin`, this.ruleForm);
                }
