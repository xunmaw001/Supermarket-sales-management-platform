<template>
	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        <view class="search-form round">
				<input :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
						v-model="searchForm.shangpinName" type="text" placeholder="商品名称"></input>
		</view>
        ...
        <view class="action">
            ...
            <view v-if="isAuth('shangpin','新增')" @click="onAddTap()"
            ...
            <view v-if="isAuth('shangpin','报表')" @tap="openChartDialog" :style="{padding:'0 10rpx',lineHeight:'80rpx',width:'auto',height:'80rpx',fontSize:'28rpx',color:'rgba(239, 239, 239, 1)',backgroundColor:btnColor[0],borderColor:btnColor[0]}">
                报表
            </view>
                ...
                <scroll-view scroll-y="true" class="tabView" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"10rpx 0 0 ","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"auto"}'>
                    <view style="display: flex;">
                        <view style="display: flex;flex-direction: column;width: 100%;">
                            <view :style='shangpinTypes===item.codeIndex?sactiveItem:sitem' class="tab"
                                  v-for="(item,index) in shangpinTypesList" :key="index" :class="shangpinTypes===item.codeIndex?'tabActive':''"
                                  @tap="shangpinTypesCategoryClick(item.codeIndex)">
                                {{item.indexName}}
                            </view>
                        </view>
                    </view>
...
<view class="list-box5"
      :style='{"padding":"24rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(228, 228, 228, 1)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
      style="box-sizing: border-box;">
    <block v-for="(product,index) in list" :key="index">
        <view @tap="onDetailTap(product)" v-if="index%6==0" class="list-item"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 12rpx","borderColor":"rgba(206, 34, 27, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
              style="display: flex;">
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"rgba(206, 34, 27, 1)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"280rpx","borderStyle":"solid","height":"180rpx"}'
                    mode="aspectFill" :src="product.shangpinPhoto?baseUrl+product.shangpinPhoto.split(',')[0]:''">
            </image>
            <view class="list-item-body" style="flex: 1;">
                <view
                        :style='{"padding":"10rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(0, 0, 0, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{product.shangpinName}}
                </view>
                <view v-if="product.shangpinNewMoney"
                      :style='{"padding":"10rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"red","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"40rpx","fontSize":"34rpx","borderStyle":"solid"}'
                      class="title hide1">￥{{product.shangpinNewMoney}}
                </view>
                <view v-else-if="product.shangpinValue"
                      :style='{"padding":"10rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(0, 0, 0, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","borderStyle":"solid"}'
                      class="title hide1">{{product.shangpinValue}}
                </view>
                <view style="display: flex;justify-content: space-between;padding: 0 10rpx">
                    <text v-if="isAuth('shangpin','修改')" class="cuIcon-edit"
                          @click.stop="onUpdateTap(product.id)">修改
                    </text>
                    <text v-if="isAuth('shangpin','删除')" class="cuIcon-delete"
        ...
        <view @tap="onDetailTap(product)" v-if="index%6==1" class="list-item"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 12rpx","borderColor":"rgba(206, 34, 27, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
              style="display: flex;">
            <view class="list-item-body" style="flex: 1;">
                <view
        ...
        <view @tap="onDetailTap(product)" v-if="index%6==2" class="list-item"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 12rpx","borderColor":"rgba(206, 34, 27, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
              style="display: flex;">
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"rgba(206, 34, 27, 1)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"280rpx","borderStyle":"solid","height":"180rpx"}'
        ...
        <view @tap="onDetailTap(product)" v-if="index%6==3" class="list-item"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 12rpx","borderColor":"rgba(206, 34, 27, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
              style="display: flex;">
            <view class="list-item-body" style="flex: 1;">
                <view
        ...
        <view @tap="onDetailTap(product)" v-if="index%6==4" class="list-item"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 12rpx","borderColor":"rgba(206, 34, 27, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
              style="display: flex;">
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"rgba(206, 34, 27, 1)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"280rpx","borderStyle":"solid","height":"180rpx"}'
        ...
        <view @tap="onDetailTap(product)" v-if="index%6==5" class="list-item"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"rgba(206, 34, 27, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
              style="display: flex;">
            <view class="list-item-body" style="flex: 1;">
                <view
                        :style='{"padding":"10rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(0, 0, 0, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","borderStyle":"solid"}'
                ...
                <view style="display: flex;justify-content: space-between;padding: 0 10rpxpadding: 0 10rpx;">
                    <text v-if="isAuth('shangpin','修改')" class="cuIcon-edit"
                          @click.stop="onUpdateTap(product.id)">修改
                    </text>
                    <text v-if="isAuth('shangpin','删除')" class="cuIcon-delete"
...
<script>
	export default {
		...
		methods: {
            ...
            //当前表的 商品类型 字段 字典表查询方法
            async shangpinTypesSelect(){
                let shangpinTypes = await this.$api.page('dictionary', {
                    page: 1,
                    limit: 100,
                    dicCode:'shangpin_types',
                });
                shangpinTypes.data.list.splice(0, 0, {codeIndex: 0, indexName: '全部'})
                this.shangpinTypesList = shangpinTypes.data.list
            },
            //当前表的 商品类型字段类别搜索
			shangpinTypesCategoryClick(categoryName) {
			...
			async upCallback(mescroll) {
                ...
                if (this.shangpinTypes != 0) {
                    params.shangpinTypes = this.shangpinTypes
                }
                let _this = this
			...
			onDeleteTap(id) {
				...
				uni.showModal({
					...
					success: async function(res) {
						if (res.confirm) {
							await _this.$api.del('shangpin', JSON.stringify([id]));
							_this.hasNext = true
							// 重置分页参数页数为1
                ...
                uni.showModal({
                    ...
                    success: async function(res) {
                        if (res.confirm) {
                            ...
                            await _this.$api.update(`shangpin`, data);
                            _this.hasNext = true
                            // 重置分页参数页数为1
                            _this.mescroll.resetUpScroll()
                        }
			...
			async search() {
				...
				if (this.searchForm.shangpinName) {
                    searchForm['shangpinName'] = this.searchForm.shangpinName
                }

                let res = await this.$api.list(`shangpin`, searchForm);
                let _this = this
                res.data.list.forEach(function(item,index){
                    if(item.shangpinContent!=null){
                        item.shangpinContent = item.shangpinContent.replace("<img","<img  class=\"daxiao\"").replace("src=\"upload/","src=\""+_this.$base.url+"upload/");
