        ...
        <form class="app-update-pv">
                 <view
                     ...
                     <input   disabled
                              ...
                              :disabled="ro.shangpinName" v-model="shangpin.shangpinName" placeholder="商品名称"></input>
                 </view>
                 <view
                         :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                         class="cu-form-group">
                     ...
                     <input   disabled
                              :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                              :disabled="ro.shangpinUuidNumber" v-model="shangpin.shangpinUuidNumber" placeholder="商品编号"></input>
                 </view>
                <view
                    ...
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="shangpin.shangpinPhoto" :src="baseUrl+shangpin.shangpinPhoto" mode="aspectFill">
                        </image>
                        <image
                                :style='{"width":"68rpx","boxShadow":"0 0 0px rgba(0,0,0,.3)","borderRadius":"100%","textAlign":"left","height":"68rpx"}'
                    ...
                    <input disabled
                           :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                           :disabled="ro.shangpinValue"
                           v-model="shangpin.shangpinValue"
                           placeholder="商品类型"></input>
                </view>
                 <view
                         :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                         class="cu-form-group">
                     ...
                     <input   disabled
                              :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                              :disabled="ro.shangpinKucunNumber" v-model="shangpin.shangpinKucunNumber" placeholder="商品库存"></input>
                 </view>
                ...
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">会员</view>
                    <picker @change="huiyuanChange" :value="huiyuanIndex" :range="huiyuanOptions" range-key="huiyuanName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.huiyuanId?ruleForm.huiyuanName:"请选择会员"}}</view>
                    </picker>
                </view>-->
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">订单编号</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                         :disabled="ro.shangpinOrderUuidNumber" type="text" v-model="ruleForm.shangpinOrderUuidNumber" placeholder="订单编号"></input>
            </view>
                <!-- 级联表的表id -->
                ...
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">订单类型</view>
                    <picker @change="shangpinOrderTypesChange" :value="shangpinOrderTypesIndex" :range="shangpinOrderTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                                class="uni-input">{{ruleForm.shangpinOrderTypes?ruleForm.shangpinOrderValue:"请选择订单类型"}}</view>
                    </picker>
                </view>
...
<script>
    ...
    export default {
        data() {
            ...
            ruleForm: {
					shangpinOrderUuidNumber: this.getUUID(),//数字
					shangpinId: '',
					yonghuId: '',
					huiyuanId: '',
					buyNumber: '',
        ...
        async onLoad(options) {
            ...
            let huiyuanData = await this.$api.page(`huiyuan`, huiyuanParams);
            this.huiyuanOptions = huiyuanData.data.list;
		/*下拉框*/
			let shangpinOrderTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'shangpin_order_types',
            }
			let shangpinOrderTypes = await this.$api.page(`dictionary`, shangpinOrderTypesParams);
			this.shangpinOrderTypesOptions = shangpinOrderTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`shangpinOrder`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.shangpinOrderId){
                this.ruleForm.shangpinOrderId = options.shangpinOrderId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            huiyuanChange(e) {
                this.huiyuanIndex = e.target.value
                this.ruleForm.huiyuanName = this.huiyuanOptions[this.huiyuanIndex].huiyuanName
                this.ruleForm.huiyuanId = this.huiyuanOptions[this.huiyuanIndex].id
            },
            // 下拉变化
            shangpinOrderTypesChange(e) {
                this.shangpinOrderTypesIndex = e.target.value
                this.ruleForm.shangpinOrderValue = this.shangpinOrderTypesOptions[this.shangpinOrderTypesIndex].indexName
                this.ruleForm.shangpinOrderTypes = this.shangpinOrderTypesOptions[this.shangpinOrderTypesIndex].codeIndex
            },
            // styleChange() {
            // 	this.$nextTick(() => {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.shangpinOrderUuidNumber)) {
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`shangpinOrder`, this.ruleForm);
                } else {
                    await this.$api.save(`shangpinOrder`, this.ruleForm);
                }
