	...
	<view class="content">
		<view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
			...
			<view v-if="tableName=='yonghu'" class="userinfo" style="margin-bottom:40rpx;">
				...
				<view class="info">
					<view class="username"
						style="background-color: var(--publicMainColor);width:100%;margin-bottom: 10px;padding:10rpx"
		...
		<view class="list">
			...
			<view @tap="onPageTap('../changepassword/changepassword')"
				...
				<view v-if="true"
					:style='{"padding":"0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"#fff","color":"var(--publicMainColor)","isShow":true,"borderRadius":"0","borderWidth":"0","width":"30rpx","lineHeight":"30rpx","fontSize":"40rpx","borderStyle":"solid"}'
