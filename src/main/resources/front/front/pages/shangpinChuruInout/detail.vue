	...
	<script>
		export default {
			...
			async onLoad(options) {
				this.shangpinChuruInoutId = options.id;
			},
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.detail('shangpinChuruInout', this.shangpinChuruInoutId);
                    this.detail = res.data
					this.detail.shangpinChuruInoutContent = this.detail.shangpinChuruInoutContent.replace("<img","<img  class=\"daxiao\"").replace("src=\"upload/","src=\""+this.$base.url+"upload/");
					// 主图
					this.swiperList = this.detail.shangpinChuruInoutPhoto ? this.detail.shangpinChuruInoutPhoto.split(",") : [];
				},
				...
				async baoming() {
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								await _this.$api.add('shangpinChuruInoutYuyue', {
