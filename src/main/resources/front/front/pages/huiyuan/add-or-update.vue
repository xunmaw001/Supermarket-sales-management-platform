        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.huiyuanUuidNumber" type="text" v-model="ruleForm.huiyuanUuidNumber" placeholder="会员编号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">会员姓名</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                         :disabled="ro.huiyuanName" type="text" v-model="ruleForm.huiyuanName" placeholder="会员姓名"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">会员手机号</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                         :disabled="ro.huiyuanPhone" type="text" v-model="ruleForm.huiyuanPhone" placeholder="会员手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">会员身份证号</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                         :disabled="ro.huiyuanIdNumber" type="text" v-model="ruleForm.huiyuanIdNumber" placeholder="会员身份证号"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="huiyuanPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">会员头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.huiyuanPhoto" :src="baseUrl+ruleForm.huiyuanPhoto" mode="aspectFill">
                        </image>
                ...
                <view
                    ...
                    <input   disabled
                             :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                             :disabled="ro.newMoney" type="number" v-model="ruleForm.newMoney" placeholder="余额"></input>
                </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">会员邮箱</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                         :disabled="ro.huiyuanEmail" type="text" v-model="ruleForm.huiyuanEmail" placeholder="会员邮箱"></input>
            </view>
...
<script>
    ...
    export default {
        data() {
            ...
            ruleForm: {
					huiyuanUuidNumber: this.getUUID(),//数字
					huiyuanName: '',
					huiyuanPhone: '',
					huiyuanIdNumber: '',
					huiyuanPhoto: '',
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`huiyuan`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.huiyuanId){
                this.ruleForm.huiyuanId = options.huiyuanId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.huiyuanUuidNumber)) {
                    this.$utils.msg(`会员编号不能为空`);
                    return
                }
				if ((!this.ruleForm.huiyuanName)) {
                    this.$utils.msg(`会员姓名不能为空`);
                    return
                }
				if ((!this.ruleForm.huiyuanPhone) && (!this.$validate.isMobile(this.ruleForm.huiyuanPhone))) {
                    this.$utils.msg(`会员手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.huiyuanIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.huiyuanIdNumber))) {
                    this.$utils.msg(`会员身份证号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.huiyuanPhoto)) {
                    this.$utils.msg(`会员头像不能为空`);
                    return
                }
				...
				if ((!this.ruleForm.huiyuanEmail) && (!this.$validate.isEmail(this.ruleForm.huiyuanEmail))) {
                    this.$utils.msg(`会员邮箱不能为空并且需要输入正确格式`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`huiyuan`, this.ruleForm);
                } else {
                    await this.$api.save(`huiyuan`, this.ruleForm);
                }
