    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(shangpinOrder !=null){
            ...
            //级联表 会员
            //级联表
            HuiyuanEntity huiyuan = huiyuanService.selectById(shangpinOrder.getHuiyuanId());
            if(huiyuan != null){
            BeanUtils.copyProperties( huiyuan , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
...
//                            shangpinOrderEntity.setHuiyuanId(Integer.valueOf(data.get(0)));   //会员 要改的
...
//                return R.error(511,"余额不够支付");
            ...
            shangpinOrder.setShangpinOrderTruePrice(0.0); //设置实付价格
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        Integer userId = (Integer) request.getSession().getAttribute("userId");
            ...
            Integer huiyuanId = Integer.valueOf(String.valueOf(params.get("huiyuanId")));//会员
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            ...
            //赋值订单信息
            shangpinOrderEntity.setShangpinOrderUuidNumber(shangpinOrderUuidNumber);//订单编号
            shangpinOrderEntity.setShangpinId(shangpinId);//商品
            shangpinOrderEntity.setShangpinOrderTruePrice(shangpinEntity.getShangpinNewMoney());
                        shangpinOrderEntity.setYonghuId(userId);//用户
            shangpinOrderEntity.setHuiyuanId(huiyuanId);
